 ...
 * Description: RC Google Analytics is a simple plugin that integrates the Google Analytics tracking code into your Header. It allows you to turn off and on the tracking code; insert a custom tracking code; and allows for the Display Advertising tracker.
 * Version: 1.0
